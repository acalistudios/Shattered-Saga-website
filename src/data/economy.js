...
export const GENERIC_ITEM_VALUES = [
  ...
  priced('Boiling Sea Charter', 100, 'lore', 'A navigational chart for crossing the Boiling Sea safely.'),
  priced('Everwarm Elixir', 100, 'alchemy', 'An alchemical elixir to survive frost tempests.'),
  priced('Siren Glass Charm', 150, 'relics', 'An elven charm that protects against Siren songs.'),
